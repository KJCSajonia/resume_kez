          ...
          <div class="education">
            ...
            <table class="education-table">
                <?php foreach ($education_data as $edu): ?>
                    ...
                    <tr>
                        <td colspan="2" class="school"><?= $edu['school']; ?></td>
                    </tr>
                    <?php if (!empty($edu['description'])): ?>
                    <tr>
                        <td colspan="2"><?= $edu['description']; ?></td>
                    </tr>
                    <?php endif; ?>
                    ...
                    <?php foreach ($course_data as $course): ?>
                        <?php if ($course['id_ed_fk'] == $edu['id_ed']): ?>
                            <tr>
                                <td colspan="2"><b>Elective:</b> <?= $course['elective']; ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"><b>Relevant Courses:</b> <?= $course['course']; ?></td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endforeach; ?>
                ...
                <table class="projects-table">
                    <?php if (!empty($projects)): ?>
                        <?php foreach ($projects as $project): ?>
                            <tr>
                                <td><strong><?= esc($project['project']) ?></strong></td>
                                <td><?= esc($project['date']) ?></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="role"><?= esc($project['role']) ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"><?= esc($project['description']) ?></td>
                            </tr>
            ...
            <div class="tech-stack">
                ...
                <div>
                    ...
                    <svg height="40" width="40" viewBox="0 0 128 128">
                        ...
                        <path fill="#5aa579" d="M105.72 54.9L73.14 39.42l-1.83-.9-1.12 2.28L64 53.41V68.3l9.15-18.08 21.5 9.57-23.09 10.37-.87.47v10.88L73 80.38l32.78-15.69a2 2 0 00.92-2v-5.78a2 2 0 00-.98-2.01z"></path>
                        <path fill="#558d6c" d="M56 69.39l-21.79-9.6 23.3-10.37 1.76-.7V37.76l-3.4 1.44-33.93 15.69a2.26 2.26 0 00-1.28 2v5.77a2.22 2.22 0 001.24 2l33.44 15.52 2 .9 1.21-2.26L64 68.3V53.41z"></path>
                    </svg>
