...
<head>
    <meta charset="UTF-8">
    <title></title>
    <meta name="title" content="Resume of Kezia Sajonia">
            ...
            <?php if($personal_data): ?>
                <?php foreach($personal_data as $data):?>
                    <div class = "container-personal"> 
                                ...
                                <td>
                                <img src= <?php echo $data['picture']; ?> alt="Profile Picture" class="profile-picture">
                                </td>
                                <td><h1 class="personal-name">
                                    <?php echo $data['name']; ?></h1></td>
                                </table>
   ...
   <?php if($contact_data): ?>
    ...
    <div class="contacts">
                ...
                <table class="contents">
                    <h3 class = "connect">Contact Information </h3>
                    <tr>
                        <td>Phone</td>
                        <td class = "content"><?php echo $data['phone']; ?></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td class = "content"><?php echo $data['address']; ?></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td class = "content"><?php echo $data['email']; ?></td>
                    </tr>
                </table>
        <div class = "container-connect">
            <table >
                <td><h3 class = "collaborate-text">Collaborate with me </h3></td>
                <td class = "container-connect-icons">
                        <svg class = "connect-icon" height="32" width="32" viewBox="0 0 128 128">
                            <a href=<?php echo $data['github']; ?> target="_blank">
          ...
          <div class="education">
            ...
            <table class="education-table">
                <?php foreach ($education_data as $edu): ?>
                    <tr>
                        <td><strong><?= $edu['school']; ?></strong>
                        <span class="ed"><?= $edu['education']; ?></span>
                    </td>
                        <td><?= $edu['date']; ?></td>
                    </tr>
                    <?php if (!empty($edu['description'])): ?>
                    <tr>
                        <td colspan="2" class = "edu-desc"><?= $edu['description']; ?></td>
                    </tr>
                    <?php endif; ?>

                    <?php foreach ($course_data as $course): ?>
                        <?php if ($course['id_ed_fk'] == $edu['id_ed']): ?>
                            <tr>
                                <td colspan="2" class = "edu-desc"><b>Elective:</b> <?= $course['elective']; ?></td>
                            </tr>
                            <tr>
                                <td colspan="2" class = "edu-desc"><b>Relevant Courses:</b> <?= $course['course']; ?></td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endforeach; ?>
                        ...
                        <?php foreach ($projects as $project): ?>
                            <tr>
                                <td>
                                    ...
                                    <span="2" class="role"><?= esc($project['role']) ?></span>
                                </td>
                                <td><?= esc($project['date']) ?></td>
                            </tr>
                            <!-- <td>
                                <
                            </td> -->
                            <tr>
                                <td class = "proj-desc" colspan="2"><?= esc($project['description']) ?></td>
                            </tr>
                            <?php if (!empty($project['tech_stacks'])): ?>
                                <tr>
                                    <td colspan="2">
                                        <div class="built-using-line">
                                            <span class="built-using-text">Built using:</span>
                                            <div class="tech-stacks-container">
                                                <?php foreach ($project['tech_stacks'] as $stack): ?>
                                                    <div class="tech-stack-item" title="<?= esc($stack['tech_name']) ?>">
                                                        <?= $stack['used_stack'] ?>
        ...
        <div class="skills">
                ...
                <div class="tech-stack">
                    ...
                    if (!empty($tech_stacks)) {
                        // Sort $tech_stacks by 'tech_name' ascending
                        usort($tech_stacks, function($a, $b) {
                            return strcmp($a['tech_name'], $b['tech_name']);
                        });
                        foreach ($tech_stacks as $tech) {
                    ?>
                            <span class="tech-stack-icons"><?= $tech['used_stack'] ?></span>
                    <?php
                        }
                    }
                    ?>
